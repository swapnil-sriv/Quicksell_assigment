...
const DisplayDropdown = ({ groupingOption, sortingOption, onGroupingOptionChange, onSortingOptionChange }) => {
  ...
  const handleGroupingChange = (event) => {
    onGroupingOptionChange(event.target.value);
            ...
            {isDropdownOpen && (
                <ul className="dropdown-menu">
                    <li>
                        ...
                        <select className='form-select' id="grouping-option" value={groupingOption} onChange={handleGroupingChange}>
                    ...
                    <li>
                        ...
                        <select className='form-select' id="grouping-option" value={sortingOption} onChange={handleSortingChange}>
                            <option value="priority">Priority</option>
